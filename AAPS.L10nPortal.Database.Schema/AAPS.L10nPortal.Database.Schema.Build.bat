...
echo Start building AAPS.L10nPortal.Database.Schema.sqlproj
IF %MODE%=="DEPENDENT" echo Start building AAPS.L10nPortal.Database.Schema.sqlproj >> %BUILDLOG%
IF %MODE%=="STANDLONE" echo Start building AAPS.L10nPortal.Database.Schema.sqlproj > %BUILDLOG%	

"%MSBUILDPATH%" /t:Build "%~dp0AAPS.L10nPortal.Database.Schema.sqlproj" /P:Configuration=Release /nologo /clp:Summary /fileLogger /flp:logfile=%BUILDLOG%;append=true
SET BUILD_STATUS=%ERRORLEVEL%
IF NOT %BUILD_STATUS%==0 goto SqlProjectBuildError

echo Start publishing AAPS.L10nPortal.Database.Schema.sqlproj
echo Start publishing AAPS.L10nPortal.Database.Schema.sqlproj >> %BUILDLOG%
...
"%SQLPACKAGEPATH%"^
 ...
 /p:DoNotDropObjectTypes="Credentials;DatabaseRoles;DatabaseScopedCredentials;Logins;Permissions;RoleMembership;ServerRoleMembership;ServerRoles;Users"^
 ...
 /DeployScriptPath:"%~dp0bin\Release\AAPS.L10nPortal.Database.Schema.DeployScript.sql"^
 /sf:"%~dp0bin\Release\AAPS.L10nPortal.Database.Schema.dacpac"^
